...
class Ebizmarts_MailChimp_Helper_DataTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testDeleteLocalMCStoreData()
    {
        ...
        $param5 = array(Ebizmarts_MailChimp_Model_Config::ECOMMERCE_SYNC_DATE . "_$mailchimpStoreId", 'default', 0);

        $configMock->expects($this->exactly(6))->method('deleteConfig')->withConsecutive($param1, $param2, $param3, $param4, $param5);
