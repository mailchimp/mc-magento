...
//            ->disableOriginalConstructor()
//            ->setMethods(array('setEntityTypeFilter'))
//            ->getMock();
        ...
        $subscribersMock = $this->getMockBuilder(Ebizmarts_MailChimp_Model_Api_Subscribers::class)
            ->disableOriginalConstructor()
            ->setMethods(array('getSubscriberEmail'))
            ->getMock();
