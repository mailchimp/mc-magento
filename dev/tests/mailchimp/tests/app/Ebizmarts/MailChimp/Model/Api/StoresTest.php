...
class Ebizmarts_MailChimp_Model_Api_StoresTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testCreateMailChimpStore()
    {
        ...
        $helperMock->expects($this->once())->method('getStoreDomain')->with(
            $scopeId,
            $scope
        )
            ->willReturn(
        ...
        $helperMock->expects($this->once())->method('getStoreLanguageCode')->with(
            $scopeId,
            $scope
        )
            ->willReturn(
        ...
        $helperMock->expects($this->once())->method('getStoreTimeZone')->with(
            $scopeId,
            $scope
        )
            ->willReturn(
        ...
        $helperMock->expects($this->once())->method('getStorePhone')->with(
            $scopeId,
            $scope
        )
            ->willReturn(
        ...
        $localeMock->expects($this->once())->method('getSymbol')->willReturn(
            $currencySymbol
        )
            ->willReturn(
                $currencySymbol
        ...
        $ecommerceStoresMock->expects($this->once())->method('add')->with(
            $mailChimpStoreId,
            $listId,
            $storeName,
            $currencyCode,
    ...
    public function testDeleteMailChimpStore()
    {
        ...
        $coreResourceMock->expects($this->once())->method('getConnection')->with(
            $connectionType
        )
            ->willReturn(
        ...
        $apiStoresMock->expects($this->once())->method('getSyncBatchesResource')->willReturn(
            $syncBatchesResourceMock
        );
        $syncBatchesResourceMock->expects($this->once())->method('getMainTable')->willReturn($tableName);

        $dbAdapterInterfaceMock->expects($this->once())->method('update')->with(
            $tableName,
            $setCondition,
            $whereCondition
        );
    ...
    public function testModifyName()
    {
        ...
        $helperMock->expects($this->once())->method('getApi')->with($scopeId, $scope)->willReturn($apiMock);
        $helperMock->expects($this->once())->method('getMCStoreId')->with(
            $scopeId,
            $scope
        )
            ->willReturn(
    ...
    public function testGetMCJsUrl()
    {
        ...
        $apiStoresMock->expects($this->once())->method('getStoreConnectedSiteData')->with(
            $apiMock,
            $mailChimpStoreId
        )
            ->willReturn(
        ...
        $helperMock->expects($this->once())->method('getRealScopeForConfig')->with(
