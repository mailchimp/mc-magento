...
class Mandrill_Subaccounts
{
     ...
     *         - custom_quota integer an optional manual hourly quota for the subaccount. If not specified, the hourly
     *          quota will be managed based on reputation
     ...
     *         - created_at string the date and time that the subaccount was created as a UTC string
     *          in YYYY-MM-DD HH:MM:SS format
     *         - first_sent_at string the date and time that the subaccount first sent as a UTC string
     *          in YYYY-MM-DD HH:MM:SS format
     *         - sent_weekly integer the number of emails the subaccount has sent so far this week
     *          (weeks start on midnight Monday, UTC)
     *         - sent_monthly integer the number of emails the subaccount has sent so far this month
     ...
     * @param  integer $customQuota an optional manual hourly quota for the subaccount. If not specified, Mandrill will
     * manage this based on reputation
     * @return struct the information saved about the new subaccount
     *     - id string a unique indentifier for the subaccount
     *     - name string an optional display name for the subaccount
     *     - custom_quota integer an optional manual hourly quota for the subaccount. If not specified, the hourly quota
     ...
     *         - unique_clicks integer the number of unique clicks for emails sent for this subaccount in the last
     *           30 days
     */
     ...
     *     - id string a unique indentifier for the subaccount
     *     - name string an optional display name for the subaccount
     *     - custom_quota integer an optional manual hourly quota for the subaccount. If not specified,
