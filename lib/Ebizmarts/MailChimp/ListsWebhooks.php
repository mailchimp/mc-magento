...
class MailChimp_ListsWebhooks extends MailChimp_Abstract
{
     ...
     * @param null                              $events  The events that can trigger the webhook and whether they are
     *                                          enabled.
     * @param null                              $sources The possible sources of any events that can trigger a webhook
