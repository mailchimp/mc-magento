...
class MailChimp_EcommercePromoRulesPromoCodes extends MailChimp_Abstract
{
     ...
     */
    public function add($storeId, $promoRuleId, $promoCodeId, $code, $redemptionUrl, $usageCount, $enabled = null,
                        $createdAtForeign = null, $updatedAtForeign = null)
    {
     ...
     * @throws MailChimp_HttpError
     */
    public function modify($storeId, $promoRuleId, $promoCodeId, $code = null, $redemptionUrl = null,
                           $usageCount = null, $enabled = null, $createdAtForeign = null, $updatedAtForeign = null)
    {
        $_params = array();
        if ($code) {
            $_params['code'] = $code;
        ...
        return $this->_master->call(
            'ecommerce/stores/' . $storeId . '/promo-rules/' . $promoRuleId .
            '/promo-codes/' . $promoCodeId, $_params, Ebizmarts_MailChimp::PATCH
        );
    }
